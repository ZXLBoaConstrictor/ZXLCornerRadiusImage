...
//            imageView.image = [UIImage imageNamed:@"timg.jpeg"];
            ...
            [imageView mas_makeConstraints:^(MASConstraintMaker *make) {
                make.left.mas_equalTo(kHeight * (i-1));
                make.top.mas_equalTo(2);
                make.width.height.mas_equalTo(kHeight);
            }];
        }
    ...
    for (int i=1; i<=total; i++) {
        ...
        [imageView sd_setImageWithURL:url placeholderImage:[UIImage imageNamed:@"timg.jpeg"]];
    }
